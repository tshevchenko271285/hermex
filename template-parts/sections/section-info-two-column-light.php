...
<section class="info-two-column-light" <?= $section_id; ?> >
	<div class="container">
		<? $icon = get_sub_field('icon') ? get_sub_field('icon') : false; ?>
		<? if($icon) : ?>
			<div class="info-two-column-light_icon">
		...
		<div class="row">
			...
			<? if($left_text) : ?>
				<div class="col-lg-6 info-two-column-light_border">
					<p class="info-two-column-light_text"><?= $left_text; ?></p>
				</div>
			<? endif; ?>
			<? $right_text = get_sub_field('right_text') ? get_sub_field('right_text') : false; ?>
			<? if($right_text) : ?>
				<div class="col-lg-6 info-two-column-light_border">
					<p class="info-two-column-light_text"><?= $right_text; ?></p>
				</div>
			<? endif; ?>
		</div>
	</div>
